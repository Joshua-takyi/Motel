		...
		<div className="fixed top-0 left-0 w-full h-full -z-10">
			<div className="h-full w-full dark:bg-black bg-white dark:bg-grid-white/[0.05] bg-grid-black/[0.05] relative flex items-center justify-center">
				...
				<div
					...
					style={{
						backgroundImage: `
            radial-gradient(at 27% 37%, hsla(215, 80%, 70%, 0.8) 0px, transparent 50%),
            radial-gradient(at 10% 29%, hsla(215, 80%, 70%, 0.8) 0px, transparent 50%),
            radial-gradient(at 55% 100%, hsla(285, 80%, 65%, 0.8) 0px, transparent 50%),
            radial-gradient(at 42% 89%, hsla(285, 80%, 65%, 0.8) 0px, transparent 50%),
            radial-gradient(at 97% 21%, hsla(32, 80%, 70%, 0.8) 0px, transparent 50%),
            radial-gradient(at 69% 43%, hsla(32, 80%, 70%, 0.8)  0px, transparent 50%)
            `,
					}}
				></div>
			</div>
